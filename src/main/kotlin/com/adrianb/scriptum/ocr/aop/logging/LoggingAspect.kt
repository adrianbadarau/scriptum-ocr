package com.adrianb.scriptum.ocr.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianb.scriptum.ocr.repository..*)" +
            " || within(com.adrianb.scriptum.ocr.service..*)" +
            " || within(com.adrianb.scriptum.ocr.web.rest..*)"
    )
