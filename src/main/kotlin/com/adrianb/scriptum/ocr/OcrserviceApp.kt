...
import com.adrianb.scriptum.ocr.config.ApplicationProperties
...
class OcrserviceApp(private val env: Environment) : InitializingBean {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<OcrserviceApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(OcrserviceApp::class.java)
